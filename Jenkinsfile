  ...
  stages {
    ...
    stage("Locust test") {
      steps {
        ...
        locust --headless -f /var/jenkins_home/workspace/PyTests_CI_CD/TestFiles/locustfile.py --host https:/ --users 50 -r 10 -t 2m -s 20 --exit-code-on-error 0 --json --skip-log > /var/jenkins_home/workspace/PyTests_CI_CD/TestReports/locust_report_20.json
        locust --headless -f /var/jenkins_home/workspace/PyTests_CI_CD/TestFiles/locustfile.py --host https:/ --users 70 -r 20 -t 2m -s 20 --exit-code-on-error 0 --json --skip-log > /var/jenkins_home/workspace/PyTests_CI_CD/TestReports/locust_report_20.json
        '''
      }
    }
